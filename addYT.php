...
<head>
  ...
  <title>Mobile Apllication</title>
        ...
        <div class="col-12 mt-1">
          <div class="row">
            <div class="col-12 text-center bg-dark">
              <h2 class=" text-primary title1 fw-bolder mb-1 ">Add Mobile Application Development Inqueries</h2>
            </div>
            <hr class="border border-1 border-light" />
            <div class="col-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="row">
                              ...
                              <div class="offset-lg-3 col-12 col-lg-7 d-grid mt-3 mb-3">
                                <input type="text" name="charset" id="link"
                                  class="form-control bg-transparent border border-2 border-info text-light fw-bold"
                                  placeholder="Paste Your Youtube link here">
                              </div>

                              <div class="offset-lg-3 col-12 col-lg-7 d-grid mt-3">
                                <input type="file" class="d-none" id="imageuploder" multiple />
                                <label for="imageuploder"
                                  class="col-12 btn btn-outline-success border border-3 border-success text-uppercase fw-bold"
                                  onclick="changeProductimg();">Upload Images</label>
                              </div>
                            </div>
                          </div>
                          <br>
                          <div class="col-12 text-center">
                            <div class="offset-lg-3 col-12 col-lg-7 d-grid mt-3 mb-3">
                              <button class="btn btn-outline-primary fw-bold" onclick="addYTProduct();">ADD &
                                SAVE</button>
                            </div>

                            <div class="offset-lg-3 col-12 col-lg-7 d-grid mt-3 mb-3">
                              <button class="btn btn-outline-danger fw-bold"
                                onclick='window.location = "adminpanel.php"'>Back to Admin Dashboard</button>
                            </div>
                          </div>
