...
<head>
	<meta charset="utf-8">
	<title>Delta Codex Software solutions | Testimonials</title>
	<!-- Stylesheets -->
...
<body>
	...
	<div class="page-wrapper">
				...
				<div class="auto-container clearfix">
					<div class="top-left clearfix">
						<div class="text"><span class="icon flaticon-call-answer"></span> Need help? Call Us Now : <a
								href="tel:+94751441764" class="number">0751441764</a></div>
		...
		<section class="testimonials-page-section"
			style="background-image: url(images/main-slider/13.jpg); width: auto;">
			<div class="auto-container">
				<!-- Sec Title -->
				<div class="sec-title-two centered">
					<h2 class="text-light font-weight-bold">What our Clients says</h2>
				</div>
